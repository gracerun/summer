...
public class StringHelper {
     ...
     * @return 字符串数组
     */
    public static String[] split(String list, String separator) {
        return split(list, separator, false);
    }
     ...
     * @return 字符串数组
     */
    public static String[] split(String list, String separator, boolean include) {
        StringTokenizer tokens = new StringTokenizer(list, separator, include);
    ...
    /**
     * 描述：判断一个字符是ASCII-字符还是其它字符（如汉，日，韩文字符）
     *
     * @param c 需要判断的字符
     * @return boolean
     */
