...
/**
 * 解决文档框架NullPointerException bug
 *
 * @author Tom
 * @version 1.0.0
 * @date 3/7/22
...
public class WebMvcRequestHandler implements RequestHandler {
    ...
    public RequestHandlerKey key() {
        ...
        Set<String> pathMappings = Collections.EMPTY_SET;
        if (Objects.nonNull(requestMapping.getPatternsCondition())) {
            pathMappings = requestMapping.getPatternsCondition().getPatterns();
        }
