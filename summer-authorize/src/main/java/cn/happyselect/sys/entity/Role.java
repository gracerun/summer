...
public class Role extends BaseEntity {
    ...
    private static final long serialVersionUID = 3372409481230447L;
    ...
    @Length(max = 32, message = "{role.systemType.length}")
    ...
    @ColumnWidth(20)
    @ExcelProperty("归属用户ID")
    @Length(max = 32, message = "{role.userId.length}")
